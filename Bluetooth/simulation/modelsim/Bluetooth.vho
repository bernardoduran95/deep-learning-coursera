...
-- dato_rx[0]	=>  Location: PIN_35,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[1]	=>  Location: PIN_97,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[2]	=>  Location: PIN_33,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[3]	=>  Location: PIN_101,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[4]	=>  Location: PIN_64,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[5]	=>  Location: PIN_188,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[6]	=>  Location: PIN_90,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- dato_rx[7]	=>  Location: PIN_72,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \LessThan0~1_combout\ = (!char(6) & (!char(7) & (!char(8) & !char(5))))
...
-- Equation(s):
-- \Mux3~0_combout\ = (char(0) & (!char(2) & (char(1) $ (char(3)))))
...
-- Equation(s):
-- \Mux5~0_combout\ = (char(0) & ((char(3) & (!char(1))) # (!char(3) & ((!char(2)))))) # (!char(0) & (char(1) & (char(2) & !char(3))))
...
-- Equation(s):
-- \inst_clk_872|clk_out~0_combout\ = \inst_clk_872|cnt\(3) $ (((\inst_clk_872|cnt\(0) & (\inst_clk_872|cnt\(1) & \inst_clk_872|cnt\(2)))))
...
PORT MAP (
	...
	datab => \inst_clk_9600|Add0~2_combout\,
...
PORT MAP (
	...
	datad => \inst_clk_9600|LessThan1~1_combout\,
	combout => \inst_clk_9600|LessThan1~2_combout\);

-- Location: LCCOMB_X12_Y13_N28
\inst_clk_9600|LessThan1~3\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst_clk_9600|LessThan1~3_combout\ = (\inst_clk_9600|Add0~20_combout\ & (((\inst_clk_9600|LessThan1~0_combout\ & !\inst_clk_9600|LessThan1~2_combout\)))) # (!\inst_clk_9600|Add0~20_combout\ & (((\inst_clk_9600|LessThan1~0_combout\ & 
-- !\inst_clk_9600|LessThan1~2_combout\)) # (!\inst_clk_9600|Add0~22_combout\)))
...
-- Equation(s):
-- \inst_clk_9600|clk_out~0_combout\ = (\inst_clk_9600|Add0~10_combout\ & ((\inst_clk_9600|Add0~8_combout\) # ((\inst_clk_9600|Add0~6_combout\ & \inst_clk_9600|Add0~4_combout\))))
...
-- Equation(s):
-- \inst_clk_9600|clk_out~1_combout\ = (\inst_clk_9600|Add0~14_combout\) # ((\inst_clk_9600|Add0~12_combout\) # ((\inst_clk_9600|clk_out~0_combout\) # (\inst_clk_9600|Add0~16_combout\)))
...
PORT MAP (
	...
	datad => \inst_clk_9600|Add0~16_combout\,
...
-- Equation(s):
-- \inst_clk_9600|Equal0~0_combout\ = (((\inst_clk_9600|Add0~4_combout\) # (\inst_clk_9600|Add0~2_combout\)) # (!\inst_clk_9600|Add0~8_combout\)) # (!\inst_clk_9600|Add0~6_combout\)
...
-- Equation(s):
-- \inst_clk_872|cnt~2_combout\ = (\inst_clk_872|cnt\(2) & (\inst_clk_872|cnt\(3) $ (((\inst_clk_872|cnt\(0) & \inst_clk_872|cnt\(1)))))) # (!\inst_clk_872|cnt\(2) & (\inst_clk_872|cnt\(3) & ((\inst_clk_872|cnt\(0)) # (!\inst_clk_872|cnt\(1)))))
...
-- Equation(s):
-- \inst_clk_9600|cnt~0_combout\ = (\inst_clk_9600|Add0~24_combout\ & ((\inst_clk_9600|LessThan1~3_combout\) # (\inst_clk_9600|Equal0~2_combout\)))
...
-- Equation(s):
-- \inst_clk_9600|cnt~1_combout\ = (\inst_clk_9600|Add0~20_combout\ & ((\inst_clk_9600|LessThan1~3_combout\) # (\inst_clk_9600|Equal0~2_combout\)))
...
-- Equation(s):
-- \inst_clk_9600|cnt~2_combout\ = (\inst_clk_9600|Add0~12_combout\ & ((\inst_clk_9600|LessThan1~3_combout\) # (\inst_clk_9600|Equal0~2_combout\)))
...
-- Equation(s):
-- \inst_clk_9600|cnt~3_combout\ = (\inst_clk_9600|Add0~8_combout\ & ((\inst_clk_9600|LessThan1~3_combout\) # (\inst_clk_9600|Equal0~2_combout\)))
...
-- Equation(s):
-- \LessThan0~2_combout\ = (!char(9) & (!char(10) & (!char(12) & !char(11))))
...
-- Equation(s):
-- \LessThan0~0_combout\ = ((!char(2) & (!char(3) & !char(1)))) # (!char(4))
...
-- Equation(s):
-- \LessThan0~3_combout\ = (!char(16) & (!char(15) & (!char(13) & !char(14))))
...
-- Equation(s):
-- \LessThan0~6_combout\ = (!char(23) & (!char(21) & (!char(22) & !char(24))))
...
-- Equation(s):
-- \LessThan0~7_combout\ = (!char(26) & (!char(28) & (!char(25) & !char(27))))
...
-- Equation(s):
-- \LessThan0~5_combout\ = (!char(17) & (!char(18) & (!char(19) & !char(20))))
...
-- Equation(s):
-- \LessThan0~8_combout\ = (!char(30) & (\LessThan0~6_combout\ & (\LessThan0~7_combout\ & \LessThan0~5_combout\)))
...
-- Equation(s):
-- \Mux1~0_combout\ = (!char(2) & (!char(3) & !char(1)))
...
-- Equation(s):
-- \Mux0~0_combout\ = (char(0) & ((char(2) $ (!char(3))) # (!char(1)))) # (!char(0) & ((char(1)) # ((char(3)) # (!char(2)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111011101101111",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => char(0),
...
-- Equation(s):
-- \inst_tx_uart|Selector0~0_combout\ = (\inst_tx_uart|estado.d5~regout\ & ((dato_tx(5)) # ((\inst_tx_uart|estado.d6~regout\ & dato_tx(6))))) # (!\inst_tx_uart|estado.d5~regout\ & (((\inst_tx_uart|estado.d6~regout\ & dato_tx(6)))))
...
-- Equation(s):
-- \inst_tx_uart|Selector0~2_combout\ = (dato_tx(1) & ((\inst_tx_uart|estado.d1~regout\) # ((\inst_tx_uart|estado.d2~regout\ & dato_tx(2))))) # (!dato_tx(1) & (\inst_tx_uart|estado.d2~regout\ & ((dato_tx(2)))))
...
-- Equation(s):
-- \Mux6~0_combout\ = (char(0) & (char(3) $ (((char(1) & char(2)))))) # (!char(0) & ((char(1) & (!char(2) & !char(3))) # (!char(1) & (char(2)))))
...
-- Equation(s):
-- \Mux6~1_combout\ = (char(4) & (char(0) & (\Mux1~0_combout\))) # (!char(4) & (((!\Mux6~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst_tx_uart|estado.d0~regout\,
	datac => \inst_tx_uart|estado.idle~regout\,
	datad => dato_tx(0),
...
-- Equation(s):
-- \Mux2~1_combout\ = (\Mux2~0_combout\ & !char(4))
...
-- Equation(s):
-- \inst_tx_uart|Selector0~1_combout\ = (dato_tx(3) & ((\inst_tx_uart|estado.d3~regout\) # ((\inst_tx_uart|estado.d4~regout\ & dato_tx(4))))) # (!dato_tx(3) & (\inst_tx_uart|estado.d4~regout\ & ((dato_tx(4)))))
...
PORT MAP (
	...
	datac => \inst_tx_uart|estado.d3~regout\,
	datad => dato_tx(4),
