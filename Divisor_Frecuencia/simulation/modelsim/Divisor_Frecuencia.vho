...
-- rst	=>  Location: PIN_37,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \cnt~1_combout\ = (cnt(1) & (cnt(3) $ (((cnt(2) & cnt(0)))))) # (!cnt(1) & (cnt(3) & ((cnt(2)) # (cnt(0)))))
